...
const char searchname[2][25]={"Linear Search","Binary Search"};
const char diskname[6][25]={"FCFS","SSTF","SCAN","C-SCAN","LOOK","C-LOOK"};
int dominatelist[10]={456,23,176,244,253,80,0,0,0,0};
double timelist[10]={0.701961, 0.234512, 1.245521, 1.523890, 0.701961, 0.701961, 0.701961, 0.701961, 0.701961, 0.701961};
...
void chartor(int typenum)
{
	...
	gtk_window_set_title(GTK_WINDOW(window), "Performance Chart");
...
static void do_drawing(cairo_t *cr)
{
	...
	switch(type_no)
	{
		...
		break;
		case 1: curr_list=&searchname[0];
		break;
		case 2: curr_list=&diskname[0];
		break;
